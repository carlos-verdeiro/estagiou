<section class="sectionPages sectionPagesEscola" id="sectionPageVagas">
    <link rel="stylesheet" href="../assets/css/dashboard/escola/vagas.css">
    <script src="../assets/js/dashboard/escola/vagas.js"></script>
