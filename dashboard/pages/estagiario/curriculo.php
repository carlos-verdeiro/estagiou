            ...
            <div class="accordion-item"> 
                ...
                <div id="acordeaoFormacao" class="accordion-collapse collapse" data-bs-parent="#acordeao">
                    <div class="accordion-body">
                        <form method="post" class="p-4" id="formFormacao">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="formacao" maxlength="1000" aria-describedby="formacao" style="height: 150px"></textarea>
                            </div>
                    ...
                    <div class="accordion-body">
                        <form method="post" class="p-4">
                            <div class="mb-3">
                                ...
                                <textarea required maxlength="1000" class="form-control" id="experiencias" aria-describedby="experiencias" style="height: 150px"></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary">Salvar</button>
                        </form>
                    </div>
                    ...
                    <div class="accordion-body">
                        <form method="post" class="p-4">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="disponibilidade" type="checkbox" value="integral" id="integral">
                                    <label class="form-check-label" for="integral">Período Integral</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="disponibilidade" type="checkbox" value="meioPeriodo" id="meioPeriodo">
                                    <label class="form-check-label" for="meioPeriodo">Meio Período</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="disponibilidade" type="checkbox" value="remoto" id="remoto">
                                    <label class="form-check-label" for="remoto">Remoto</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="disponibilidade" type="checkbox" value="presencial" id="presencial">
