<section class="sectionPages sectionPagesEmpresa" id="sectionPageMenu">
    ...
    <div class="container text-center containerBlocosMenu">
        <div class="row row-cols-2 divBlocosMenu">
            ...
            $update_stmt = $connUpdate->prepare("SELECT ultimo_login FROM empresa WHERE id = :id");
            ...
            if (!$row['ultimo_login']) {
                ...
                $update_stmt = $connUpdate->prepare("UPDATE empresa SET ultimo_login = NOW() WHERE id = :id");
