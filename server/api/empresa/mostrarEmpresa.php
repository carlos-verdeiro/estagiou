...
switch ($busca) {
    ...
    case 'empresa':
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT nome,cnpj,area_atuacao,descricao,email,telefone,website,instagram,facebook,linkedin,endereco,bairro,numero,complemento,cidade,estado,cep,pais,nome_responsavel,email_responsavel,telefone_responsavel,cargo_responsavel FROM empresa WHERE id = ?;");
